...
export function TermsOfService() {
  return (
    <LegalShell
      ...
      title="이용약관"
      description="UniFoli는 학생 기록과 탐구 준비를 돕는 도구이며, 안전하고 책임 있는 사용을 전제로 운영됩니다."
    >
      <LegalSection title="서비스의 범위" icon={<Scale size={20} />}>
        <p>
          UniFoli는 학생의 생기부와 실제 활동 기록을 정리하고, AI 진단과 탐구 플랜, 작업실 drafting 흐름을 지원하는 서비스입니다.
        </p>
        <div className="flex items-start gap-4 rounded-2xl border border-amber-100 bg-amber-50/60 p-6">
          ...
          <p className="text-sm font-bold leading-7 text-amber-700">
            UniFoli는 특정 대학의 합격이나 입시 결과를 보장하지 않습니다. 최종 판단과 제출 책임은 사용자와 교육 기관에 있습니다.
          </p>
        </div>
      </LegalSection>
...
export function PrivacyPolicy() {
  return (
    <LegalShell
      ...
      title="개인정보처리방침"
      description="UniFoli는 학생 기록과 개인정보를 다루는 만큼, 수집 범위와 처리 목적을 가능한 한 분명하게 안내합니다."
    >
