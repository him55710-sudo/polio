...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    'border-transparent bg-[#f2f4f6] text-[#333d4b] hover:bg-blue-50 hover:text-[#3182f6] active:scale-[0.96]',
...
export function buttonClassName(options: ButtonStyleOptions = {}) {
  ...
  return cn(
    ...
    'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3182f6]/30 focus-visible:ring-offset-2',
