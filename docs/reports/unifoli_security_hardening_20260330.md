# UniFoli Security Hardening Pass

Date: 2026-03-30
Repository: `him55710-sudo/unifoli`
Product: `uni folia`
...
- Internal storage path exposure in API responses.
  ...
  - Files: `backend/services/api/src/unifoli_api/schemas/document.py`, `backend/services/api/src/unifoli_api/schemas/upload_asset.py`, `backend/services/api/src/unifoli_api/schemas/render_job.py`, `backend/services/api/src/unifoli_api/services/render_job_service.py`
...
- Workshop stream tokens never expired server-side.
  ...
  - Files: `backend/services/api/src/unifoli_api/api/routes/workshops.py`, `backend/services/api/src/unifoli_api/db/models/workshop.py`, `backend/services/api/src/unifoli_api/core/database.py`, `backend/alembic/versions/20260330_0011_add_workshop_stream_token_expiry.py`
...
- OAuth `state` was signed but not client-bound and not replay-resistant.
  ...
  - Files: `backend/services/api/src/unifoli_api/core/oauth_state.py`, `backend/services/api/src/unifoli_api/api/routes/auth.py`
...
- Public, unthrottled research paper search proxied third-party providers.
  ...
  - Files: `backend/services/api/src/unifoli_api/api/routes/research.py`
...
- Hardcoded KCI fallback API key.
  ...
  - Files: `backend/services/api/src/unifoli_api/core/config.py`, `backend/services/api/src/unifoli_api/services/scholar_service.py`
...
- Raw ingest/job failure strings could be stored and later returned through user-visible APIs.
  ...
  - Files: `backend/services/api/src/unifoli_api/core/security.py`, `backend/services/api/src/unifoli_api/services/document_service.py`, `backend/services/api/src/unifoli_api/services/research_service.py`, `backend/services/api/src/unifoli_api/services/async_job_service.py`, `backend/services/api/src/unifoli_api/schemas/document.py`, `backend/services/api/src/unifoli_api/schemas/research.py`, `backend/services/api/src/unifoli_api/schemas/upload_asset.py`
...
- High-risk route payloads lacked size boundaries.
  ...
  - Files: `backend/services/api/src/unifoli_api/schemas/project.py`, `backend/services/api/src/unifoli_api/schemas/draft.py`, `backend/services/api/src/unifoli_api/schemas/user.py`, `backend/services/api/src/unifoli_api/schemas/workshop.py`, `backend/services/api/src/unifoli_api/schemas/research.py`, `backend/services/api/src/unifoli_api/schemas/render_job.py`, `backend/services/api/src/unifoli_api/api/routes/projects.py`
...
- Expensive retry/process endpoints lacked throttling.
  ...
  - Files: `backend/services/api/src/unifoli_api/api/routes/jobs.py`, `backend/services/api/src/unifoli_api/api/routes/render_jobs.py`, `backend/services/api/src/unifoli_api/api/routes/workshops.py`
...
- Non-local production could still be configured with localhost OAuth redirect URIs.
  ...
  - Files: `backend/services/api/src/unifoli_api/core/config.py`
...
- Internal operational logs still rely on standard stack traces for some worker/render failures.
  ...
  - Files: `backend/services/api/src/unifoli_api/main.py`, `backend/services/api/src/unifoli_api/services/render_job_service.py`, `backend/services/api/src/unifoli_api/api/routes/workshops.py`, `backend/services/api/src/unifoli_api/api/routes/projects.py`
