...
from unifoli_render.markdown import split_markdown_sections
...
class PdfRenderer(BaseRenderer):
    ...
    def _build_pdf(self, context: RenderBuildContext, output_path) -> None:
        ...
        doc = SimpleDocTemplate(
            ...
            author=context.requested_by or "unifoli backend",
        )
    ...
    def _draw_page_chrome(canvas, doc, theme: PdfVisualTheme, template_label: str) -> None:
        ...
        canvas.drawString(doc.leftMargin, height - 12, f"UNIFOLI DIAGNOSIS REPORT | {template_label.upper()}")
