...
from unifoli_api.core.database import SessionLocal, initialize_database
from unifoli_api.services.async_job_service import get_async_job, process_async_job, process_next_async_job
from unifoli_shared.paths import ensure_app_directories


def main() -> None:
    parser = argparse.ArgumentParser(description="unifoli background worker")
